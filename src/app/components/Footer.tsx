...
const footerLinks = {
  Shop: [
    ...
    { label: "Accessories", to: "/category/accessory" },
    { label: "iPhone Deals", to: "/category/iphone" },
  ],
  Support: [
    { label: "Warranty Info", to: "/faq" },
    { label: "Returns Policy", to: "/faq" },
    { label: "Shipping Info", to: "/faq" },
    { label: "Contact Us", to: "/contact" },
    { label: "FAQ", to: "/faq" },
  ],
  Company: [
    { label: "About MacOutlet", to: "/" },
    { label: "Certification Process", to: "/" },
